...
module.exports = Builder = function builder(options) {
	...
	throw new Error(errMsg('current working directory', 'opts.cwd'));
    if (typeof this.opts.src === 'undefined')
	throw new Error(errMsg('source directory', 'opts.src'));
    if (typeof this.opts.dest === 'undefined')
	throw new Error(errMsg('destination directory', 'opts.dest'));
    if (typeof this.opts.jdir === 'undefined')
	throw new Error(errMsg('json directory', 'opts.jdir'));
