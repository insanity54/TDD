...
var Overlord = function Overlord(options) {
    ...
    if (typeof self.opts.youtube === 'undefined') throw new Error('overlord must get the youtube module as option');
    if (typeof self.opts.queue === 'undefined') throw new Error('overlord must get the queue module as option');
    if (typeof self.opts.channel === 'undefined') throw new Error('overlord must get a {string} channel as option');
    
    self.youtube = self.opts.youtube;
